  ...
  void run(o2::framework::ProcessingContext& pc) final
  {
    ...
    for (int iSide = 0; iSide < 2; ++iSide) {
      ...
      if (mDebug) {
        ...
        mIDCFourierTransform.dumpToFile(fmt::format("FourierEPN_{:02}_side{}.root", o2::framework::DataRefUtils::getHeader<o2::header::DataHeader*>(pc.inputs().getFirstValid(true))->tfCounter, iSide).data());
      }
