...
class IDCDrawHelper
{
 ...
 public:
  struct IDCDraw {
    float getIDC(const unsigned int sector, const unsigned int region, const unsigned int irow, const unsigned int pad) const { return mIDCFunc(sector, region, irow, pad); }
  ...
  /// draw sector
  /// \param idc struct containing function to get the values which will be drawn
