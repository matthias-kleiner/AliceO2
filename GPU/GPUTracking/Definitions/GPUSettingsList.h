...
AddOption(transformationSCFile, std::string, "", "", 0, "File name of TPC space charge correction file")
AddOption(gridSCZ, int, 129, "", 0, "n-vertices of Grid in z direction")
AddOption(gridSCR, int, 129, "", 0, "n-vertices of Grid in r direction")
AddOption(gridSCPhi, int, 180, "", 0, "n-vertices of Grid in phi direction")
