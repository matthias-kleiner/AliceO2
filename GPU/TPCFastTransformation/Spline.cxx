...
void SplineBase<DataT, isConsistentT>::
  approximateFunction(
    ...
    std::function<void(std::vector<DataT> x[/* mXdim */], DataT f[/* mFdim */])> F, const int batchsize,
    const int nAxiliaryDataPoints[/* mXdim */])
{
  /// approximate a function F with this spline
  SplineHelper<DataT> helper;
  helper.approximateFunction(*this, xMin, xMax, F, batchsize, nAxiliaryDataPoints);
}
